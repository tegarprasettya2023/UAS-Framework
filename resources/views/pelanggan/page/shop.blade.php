                                ...
                                <div class="accordion-body">
                                    <div class="d-flex flex-column gap-4">
                                        <a href="#" class="page-link">
                                            <i class="fas fa-plus"></i> Lengan Pendek
                                        </a>
                                        <a href="#" class="page-link">
                                            <i class="fas fa-plus"></i> Raglan
                                        </a>
                                        <a href="#" class="page-link">
                                            <i class="fas fa-plus"></i> Polo
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body p-0">
                                    <div class="accordion-body">
                                        <div class="d-flex flex-column gap-4">
                                            <a href="#" class="page-link">
                                                <i class="fas fa-plus"></i> Lengan Panjang
                                            </a>
                                            <a href="#" class="page-link">
                                                <i class="fas fa-plus"></i> Raglan
                                            </a>
        ...
        <div class="col-md-9 d-flex flex-wrap gap-4 mb-4">
            <div class="card" style="width:220px;">
                <div class="card-header m-auto" style="border-radius:5px;">
                    <img src="{{ asset('assets/images/kaospendekhitam.jpg') }}" alt="baju 1" style="width: 100%;">
                </div>
                <div class="card-body">
