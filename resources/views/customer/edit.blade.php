        ...
        <form action="{{route('Customer.update', $customer)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name', $customer->name) }}" placeholder="Masukan Nama Belakang">
                    @error('name')
                ...
                <div class="col-md-6 d-grid">
                    <button type="submit" class="btn btn-success btn-lg mt-3">Edit</button>
                </div>
            </div>
        </form>
    </div>
